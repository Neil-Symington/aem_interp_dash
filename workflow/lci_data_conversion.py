...
nc_out_path = os.path.join(root, "Injune_lci_MGA55.nc")

dat_in_path = os.path.join(root, 'aseg_gdf', 'Injune_WB_MGA55.dat')

dfn_in_path = os.path.join(root, 'aseg_gdf', 'Injune_WB_MGA55.dfn')
